...
1. **씬 번호와 제목**: "몇 번째 씬인가요? 이 씬에 제목을 붙인다면?"
2. **씬의 목적**: "이 장면이 전체 영상에서 어떤 역할을 하나요? (소개, 클라이맥스, 감정 전환 등)"
3. **전달하려는 감정**: "이 씬을 보고 시청자가 어떤 감정을 느끼길 원하시나요?"
4. **예상 길이**: "이 씬은 몇 초/분 정도로 예상하시나요?"
5. **장소**: "어디서 촬영하나요? (실내/실외, 구체적인 장소)"
6. **등장인물**: "이 씬에 누가 등장하나요?"
...
추천한 기법에 대해 사용자의 의견을 받으세요:
> "위 기법들을 추천드렸습니다. 마음에 드시는 부분, 바꾸고 싶은 부분이 있으신가요?"
